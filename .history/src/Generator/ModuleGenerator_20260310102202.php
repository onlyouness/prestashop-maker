...
use Tools;
use Youness\PrestashopMaker\Utils\Tools as UtilsTools;
...
class ModuleGenerator extends AbstractGenerator
{
    ...
    {
        $className = UtilsTools::asPascalCase($data['name']);
        $target = $this->getModulePath($moduleName) . "/src/Entity/{$className}.php";
