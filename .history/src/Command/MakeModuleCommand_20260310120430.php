...
class MakeModuleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!empty($hooks)) {
            // 1. Build the "&& $this->registerHook([...])" string
            ...
            // 2. Build the "public function hook..." strings
            foreach ($hooks as $hook) {
        ...
        $io->writeln([
            ...
            " 3. Install the module in PrestaShop Back Office. or simply run:  php bin/console prestashop:module install $name "
        ]);
